...
def create_vampire_bayes_net():
    ...
    cpts = [
        create_bloodtype_cpt("X"),
        create_bloodtype_cpt("Y"),
        create_bloodtype_cpt("Z"),
        create_inheritance_cpt("X", "Z", "M"),
        create_inheritance_cpt("Y", "Z", "P"),
        create_inheritance_prior("X", "M"),
        create_inheritance_prior("X", "P"),
        create_inheritance_prior("X", "M"),
        create_inheritance_prior("X", "P"),
    ]
